...
bool configmanager::SettingsToJson(json& j)
{
	...
	j["KA_HSpeed"]             = settings::KA_HSpeed;
	j["KA_VSpeed"]             = settings::KA_VSpeed;
	j["KA_MinRotationDiff"]    = settings::KA_MinRotationDiff;
	j["KA_Legitimize"]         = settings::KA_Legitimize;
	j["KA_SimulateShortStop"]  = settings::KA_SimulateShortStop;
	j["KA_RaycastCheck"]       = settings::KA_RaycastCheck;
	j["KA_OnlyOnLMB"]          = settings::KA_OnlyOnLMB;
	j["KA_WeaponOnly"]         = settings::KA_WeaponOnly;
	j["KA_DisableWhenFlying"]  = settings::KA_DisableWhenFlying;
	j["KA_IgnoreFriends"]      = settings::KA_IgnoreFriends;
	j["KA_IgnoreInvisible"]    = settings::KA_IgnoreInvisible;
	j["KA_MinCps"]             = settings::KA_MinCps;
	j["KA_MaxCps"]             = settings::KA_MaxCps;
	j["KA_TargetPriority"]     = settings::KA_TargetPriority;
	j["KA_FovCircle"]          = settings::KA_FovCircle;
	j["KA_FovCircleColor"]     = settings::KA_FovCircleColor;

	// TriggerBot
	j["TBot_Enabled"]          = settings::TBot_Enabled;
	j["TBot_Key"]              = settings::TBot_Key;
	j["TBot_MinCps"]           = settings::TBot_MinCps;
	j["TBot_MaxCps"]           = settings::TBot_MaxCps;
	j["TBot_HoldDelay"]        = settings::TBot_HoldDelay;
	j["TBot_OnlyOnLMB"]        = settings::TBot_OnlyOnLMB;
	j["TBot_WeaponOnly"]       = settings::TBot_WeaponOnly;
	j["TBot_PlayersOnly"]      = settings::TBot_PlayersOnly;
	j["TBot_IgnoreFriends"]    = settings::TBot_IgnoreFriends;
	j["TBot_IgnoreInvisible"]  = settings::TBot_IgnoreInvisible;
	...
	j["Reach_OnlyOnLMB"]       = settings::Reach_OnlyOnLMB;
	j["Reach_WeaponOnly"]      = settings::Reach_WeaponOnly;
	j["Reach_VisibilityCheck"] = settings::Reach_VisibilityCheck;
	j["Reach_IgnoreFriends"]   = settings::Reach_IgnoreFriends;
	j["Reach_MinCps"]          = settings::Reach_MinCps;
	j["Reach_MaxCps"]          = settings::Reach_MaxCps;
	...
	// Auto Tool
	j["AT_Enabled"]            = settings::AT_Enabled;
	j["AT_Key"]                = settings::AT_Key;
	j["AT_HotkeyBack"]         = settings::AT_HotkeyBack;
	j["AT_MaxDelay"]           = settings::AT_MaxDelay;
	j["AT_OnlyWhenHoldingTool"] = settings::AT_OnlyWhenHoldingTool;

	// Notification sounds
	j["Notif_SoundsEnabled"]   = settings::Notif_SoundsEnabled;
	j["Notif_SoundOnInfo"]     = settings::Notif_SoundOnInfo;
	j["Notif_SoundOnWarning"]  = settings::Notif_SoundOnWarning;
	j["Notif_SoundOnError"]    = settings::Notif_SoundOnError;
...
bool configmanager::JsonToSettings(const json& j)
{
	...
	configmanager::GetJsonValue(j, settings::KA_HSpeed,             "KA_HSpeed");
	configmanager::GetJsonValue(j, settings::KA_VSpeed,             "KA_VSpeed");
	configmanager::GetJsonValue(j, settings::KA_MinRotationDiff,    "KA_MinRotationDiff");
	configmanager::GetJsonValue(j, settings::KA_Legitimize,         "KA_Legitimize");
	configmanager::GetJsonValue(j, settings::KA_SimulateShortStop,  "KA_SimulateShortStop");
	configmanager::GetJsonValue(j, settings::KA_RaycastCheck,       "KA_RaycastCheck");
	configmanager::GetJsonValue(j, settings::KA_OnlyOnLMB,          "KA_OnlyOnLMB");
	configmanager::GetJsonValue(j, settings::KA_WeaponOnly,         "KA_WeaponOnly");
	configmanager::GetJsonValue(j, settings::KA_DisableWhenFlying,  "KA_DisableWhenFlying");
	configmanager::GetJsonValue(j, settings::KA_IgnoreFriends,      "KA_IgnoreFriends");
	configmanager::GetJsonValue(j, settings::KA_IgnoreInvisible,    "KA_IgnoreInvisible");
	configmanager::GetJsonValue(j, settings::KA_MinCps,             "KA_MinCps");
	configmanager::GetJsonValue(j, settings::KA_MaxCps,             "KA_MaxCps");
	configmanager::GetJsonValue(j, settings::KA_TargetPriority,     "KA_TargetPriority");
	configmanager::GetJsonValue(j, settings::KA_FovCircle,          "KA_FovCircle");
	configmanager::GetJsonValue(j, settings::KA_FovCircleColor,     "KA_FovCircleColor");

	// TriggerBot
	configmanager::GetJsonValue(j, settings::TBot_Enabled,         "TBot_Enabled");
	configmanager::GetJsonValue(j, settings::TBot_Key,             "TBot_Key");
	configmanager::GetJsonValue(j, settings::TBot_MinCps,          "TBot_MinCps");
	configmanager::GetJsonValue(j, settings::TBot_MaxCps,          "TBot_MaxCps");
	configmanager::GetJsonValue(j, settings::TBot_HoldDelay,       "TBot_HoldDelay");
	configmanager::GetJsonValue(j, settings::TBot_OnlyOnLMB,       "TBot_OnlyOnLMB");
	configmanager::GetJsonValue(j, settings::TBot_WeaponOnly,      "TBot_WeaponOnly");
	configmanager::GetJsonValue(j, settings::TBot_PlayersOnly,     "TBot_PlayersOnly");
	configmanager::GetJsonValue(j, settings::TBot_IgnoreFriends,   "TBot_IgnoreFriends");
	configmanager::GetJsonValue(j, settings::TBot_IgnoreInvisible, "TBot_IgnoreInvisible");
	...
	configmanager::GetJsonValue(j, settings::Reach_OnlyOnLMB,       "Reach_OnlyOnLMB");
	configmanager::GetJsonValue(j, settings::Reach_WeaponOnly,      "Reach_WeaponOnly");
	configmanager::GetJsonValue(j, settings::Reach_VisibilityCheck, "Reach_VisibilityCheck");
	configmanager::GetJsonValue(j, settings::Reach_IgnoreFriends,   "Reach_IgnoreFriends");
	configmanager::GetJsonValue(j, settings::Reach_MinCps,          "Reach_MinCps");
	configmanager::GetJsonValue(j, settings::Reach_MaxCps,          "Reach_MaxCps");
	...
	// Auto Tool
	configmanager::GetJsonValue(j, settings::AT_Enabled,             "AT_Enabled");
	configmanager::GetJsonValue(j, settings::AT_Key,                 "AT_Key");
	configmanager::GetJsonValue(j, settings::AT_HotkeyBack,          "AT_HotkeyBack");
	configmanager::GetJsonValue(j, settings::AT_MaxDelay,            "AT_MaxDelay");
	configmanager::GetJsonValue(j, settings::AT_OnlyWhenHoldingTool, "AT_OnlyWhenHoldingTool");

	// Notification sounds
	configmanager::GetJsonValue(j, settings::Notif_SoundsEnabled,  "Notif_SoundsEnabled");
	configmanager::GetJsonValue(j, settings::Notif_SoundOnInfo,    "Notif_SoundOnInfo");
	configmanager::GetJsonValue(j, settings::Notif_SoundOnWarning, "Notif_SoundOnWarning");
	configmanager::GetJsonValue(j, settings::Notif_SoundOnError,   "Notif_SoundOnError");
